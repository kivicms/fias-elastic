...
namespace Kivicms\Fias\Elastic\Serializer;

use Exception;
use Kivicms\Fias\Elastic\Entity\AddrObj;
use Kivicms\Fias\Elastic\Entity\AddrObjDivision;
use Kivicms\Fias\Elastic\Entity\AddrObjTypes;
use Kivicms\Fias\Elastic\Entity\AdmHierarchy;
use Kivicms\Fias\Elastic\Entity\Apartments;
use Kivicms\Fias\Elastic\Entity\ApartmentTypes;
use Kivicms\Fias\Elastic\Entity\Carplaces;
use Kivicms\Fias\Elastic\Entity\ChangeHistory;
use Kivicms\Fias\Elastic\Entity\Houses;
use Kivicms\Fias\Elastic\Entity\HouseTypes;
use Kivicms\Fias\Elastic\Entity\MunHierarchy;
use Kivicms\Fias\Elastic\Entity\NormativeDocs;
use Kivicms\Fias\Elastic\Entity\NormativeDocsKinds;
use Kivicms\Fias\Elastic\Entity\NormativeDocsTypes;
use Kivicms\Fias\Elastic\Entity\ObjectLevels;
use Kivicms\Fias\Elastic\Entity\OperationTypes;
use Kivicms\Fias\Elastic\Entity\Param;
use Kivicms\Fias\Elastic\Entity\ParamTypes;
use Kivicms\Fias\Elastic\Entity\ReestrObjects;
use Kivicms\Fias\Elastic\Entity\Rooms;
use Kivicms\Fias\Elastic\Entity\RoomTypes;
