...
use Kivicms\Fias\Elastic\IndexMapper\RoomsIndexMapper;
use Kivicms\Fias\Elastic\QueryBuilder\QueryBuilder;
use Kivicms\Fias\Elastic\Tests\BaseCase;
use stdClass;

/**
 * Тест для описания индекса сущности 'Сведения по комнатам'.
 *
 * @internal
 */
class RoomsIndexMapperTest extends BaseCase
{
    public function testGetName(): void
    {
        $mapper = new RoomsIndexMapper();

        $this->assertSame('rooms', $mapper->getName());
    }
