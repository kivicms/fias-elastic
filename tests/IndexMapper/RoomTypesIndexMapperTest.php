...
use Kivicms\Fias\Elastic\IndexMapper\RoomTypesIndexMapper;
use Kivicms\Fias\Elastic\QueryBuilder\QueryBuilder;
use Kivicms\Fias\Elastic\Tests\BaseCase;
use stdClass;

/**
 * Тест для описания индекса сущности 'Сведения по типам комнат'.
 *
 * @internal
 */
class RoomTypesIndexMapperTest extends BaseCase
{
    public function testGetName(): void
    {
        $mapper = new RoomTypesIndexMapper();

        $this->assertSame('room_types', $mapper->getName());
    }
