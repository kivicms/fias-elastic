...
use Kivicms\Fias\Elastic\IndexMapper\CarplacesIndexMapper;
use Kivicms\Fias\Elastic\QueryBuilder\QueryBuilder;
use Kivicms\Fias\Elastic\Tests\BaseCase;
use stdClass;

/**
 * Тест для описания индекса сущности 'Сведения по машино-местам'.
 *
 * @internal
 */
class CarplacesIndexMapperTest extends BaseCase
{
    public function testGetName(): void
    {
        $mapper = new CarplacesIndexMapper();

        $this->assertSame('carplaces', $mapper->getName());
    }
