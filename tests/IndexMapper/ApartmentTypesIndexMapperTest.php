...
use Kivicms\Fias\Elastic\IndexMapper\ApartmentTypesIndexMapper;
 ...
 * @internal
 */
class ApartmentTypesIndexMapperTest extends BaseCase
{
    public function testGetName(): void
    {
        $mapper = new ApartmentTypesIndexMapper();

        $this->assertSame('apartment_types', $mapper->getName());
    }
