...
use Kivicms\Fias\Elastic\IndexMapper\OperationTypesIndexMapper;
use Kivicms\Fias\Elastic\QueryBuilder\QueryBuilder;
use Kivicms\Fias\Elastic\Tests\BaseCase;
use stdClass;

/**
 * Тест для описания индекса сущности 'Сведения по статусу действия'.
 *
 * @internal
 */
class OperationTypesIndexMapperTest extends BaseCase
{
    public function testGetName(): void
    {
        $mapper = new OperationTypesIndexMapper();

        $this->assertSame('operation_types', $mapper->getName());
    }
